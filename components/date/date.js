function newDate(el){
  ...
  const template = ['<div class="date-components" id="date-components">',
'        <div class="express-day">',
'            <div id = "starDay"></div>',
'            <div id = "endDay"></div>',
'        </div>',
'        <div>',
'            <div id = "cpdate-selectStar">',
'              <div class="title">',
'                  <div id="cpdate-preYear"> << </div>',
'                  <div id="cpdate-preMon"> < </div>',
'                  <div id="cpdate-month"></div>',
'                  <div id="cpdate-nextMon"> > </div>',
'                  <div id="cpdate-nextYear"> >> </div>',
'                </div>',
'                <table class="date-table" id ="cpdate-table" cellpadding = 0; cellspacing=0; rules="all"> ',
'                </table>',
'            </div>',
'            <div id = "cpdate-selectEnd">',
'                <div class="title">',
'                  <div id="cpdate-preYear2"> << </div>',
'                  <div id="cpdate-preMon2"> < </div>',
'                  <div id="cpdate-month2"></div>',
'                  <div id="cpdate-nextMon2"> > </div>',
'                  <div id="cpdate-nextYear2"> >> </div>',
'                </div>',
'                <table  class="date-table" id ="cpdate-table2" cellpadding = 0; cellspacing=0; rules="all"> ',
'                </table>',
'            </div>',
'        </div>',
'        <div id = "confirmDate">确定</div>',
'  </div>'].join("");
...
newDate.prototype.show = function(){
  let obj = document.getElementById('date-components');
  obj.className = 'date-components  date-components-show'
}

// //闭包拿到两个date数据
// let getTwoDate = newDate.getDate()

newDate.prototype.addConfirmEvent = function(fn){
   let obj = document.getElementById('date-components');
   confirmDate.addEventListener("click", function(){
      var confirmDate = document.getElementById("confirmDate");
      obj.className = 'date-components';
      fn();
   })
}
